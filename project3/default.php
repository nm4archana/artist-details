  ...
  <div class="container-fluid">
    <div class="navbar-header">
     ...
     <li><a href="#">Neelipalayam Masilamani, Archana</a></li>
      <li><form class="navbar-form navbar-left" role="search" method="get">
...
<div class="container">
      <div class="row">
        <div class="col-md-2">
          ...
          <p>When this is all about and other stuff</p>
          <a href="AboutUs.php" class="btn btn-default">
        ...
        <div class="col-md-2">
          ...
          <a href="Part01_ArtistsDataList.php" class="btn btn-default">
         <span class="glyphicon glyphicon-link"></span> Visit Page
         </a>
       </div>
        <div class="col-md-2">
         ...
         <a href="Part02_SingleArtist.php?id=19" class="btn btn-default">
         <span class="glyphicon glyphicon-link"></span> Visit Page
         </a>
        </div>
        <div class="col-md-2">
          ...
          <p>Displays Information for a Single Work</p>
           <a href="Part03_ArtistDetails.php?id=394" class="btn btn-default">
         <span class="glyphicon glyphicon-link"></span> Visit Page
         </a>
        </div>
        <div class="col-md-2">
         ...
         <a href="Part04_Search.php" class="btn btn-default">
         <span class="glyphicon glyphicon-link"></span> Visit Page
         </a>
        </div>
</div>
