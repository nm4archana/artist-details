     ...
     <ul class="nav navbar-nav">
      ...
      <a class="dropdown-toggle" data-toggle="dropdown" href="#">Pages<span class="caret"></span></a>
        <ul class="dropdown-menu">
            ...
            <li><a href="Part03-ArtistDetails.php?id=394">Single Work (Part 3)</a></li>
...
<div class="container">
  <h1>Artists Data List(Part 01)</h1><hr>
<?php
$servername = "localhost";
$username = "root";
$password = "";
$dbname = "mysql";
$url = "Part02_SingleArtist.php?";
...
$sql = "SELECT firstname, lastname, yearofbirth,yearofdeath,ArtistID FROM artists order by lastname asc";
$result = $conn->query($sql);
      
if ($result->num_rows > 0) {
     while($row = $result->fetch_assoc()) {
      $id = $row["ArtistID"];
         echo "<td> <a href='" . $url ."id=".$id. "'>". $row["firstname"]. " " . $row["lastname"] . " (".$row["yearofbirth"] ." - ".$row["yearofdeath"] .") "."</a></td></br>";
        //echo "<td> <a href='" . $url ."id=900'>". $row["firstname"]. " " . $row["lastname"] . " (".$row["yearofbirth"] ." - ".$row["yearofdeath"] .") "."</a></td></br>";
       }
} else {
     echo "0 results";
}
